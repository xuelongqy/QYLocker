...
<template>
    <div id="settings">
      ...
      <mu-dialog :open="lockModelDialogShow" :title="$t('settings.lockModelSet')" @close="lockModelDialogShow = false">
        <mu-menu>
          <mu-radio :label="$t('settings.lockModelSetInfo.stackPolling')" v-model="lockModel" @change="lockModelChange" labelLeft name="lockModelGroup" nativeValue="stackPolling" class="lock_model_radio"/>
          <mu-radio :label="$t('settings.lockModelSetInfo.listenApps')" v-model="lockModel" @change="lockModelChange" labelLeft name="lockModelGroup" nativeValue="listenApps" class="lock_model_radio"/>
          <mu-radio :label="$t('settings.lockModelSetInfo.xposed')" v-model="lockModel" @change="lockModelChange" labelLeft name="lockModelGroup" nativeValue="xposed" class="lock_model_radio"/>
        </mu-menu>
      </mu-dialog>
      <!--重新锁定-->
