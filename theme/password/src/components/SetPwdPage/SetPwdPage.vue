  ...
  <div id="set_pwd_page">
    ...
    <div v-if="!isVerifyPassword" class="set_pwd_box">
      ...
      <div class="pwd_input_box">
        <!--密码输入框-->
        <mu-text-field class="pwd_input" inputClass="pwd_input_style" :maxLength="16" v-model="password" :hintText="$t('setPwdPage.inputPwd')" type="password" @keyup.enter.native="onOkBtn"/>
        <!--密码提示文字-->
    ...
    <div v-else class="verify_pwd_box">
      ...
      <div class="pwd_input_box">
        <!--密码输入框-->
        <mu-text-field class="pwd_input" inputClass="pwd_input_style" :maxLength="16" v-model="verifyPassword" :hintText="$t('setPwdPage.inputPwd')" type="password" @keyup.enter.native="onOkBtn"/>
      </div>
    </div>
    <!--两次密码验证错误提示框-->
